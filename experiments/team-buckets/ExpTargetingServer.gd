...
## Overrides ExpA_EntityServer. [br]
...
func _scan_chunk(p_chunkId: int) -> void:
	...
	for l_team: int in _teamCount:
		...
		var l_candidateId: int = _chunking._centerHead[l_team * _chunkCount + p_chunkId]
